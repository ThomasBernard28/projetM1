...
if uploaded_file is not None:
    ...
    if uploaded_file.name.endswith(".xls"):
        ...
        results_of_jade_B1 = norm.get_student_results_by_period(results_of_jade, ["B1"])
        #print(norm.get_student_results_by_competence(results_of_jade_B1, ["SSFL"]))
        print(norm.get_global_class_mean(workspace.dataframes))
